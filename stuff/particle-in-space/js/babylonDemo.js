...
var Bullet = function (camera, scene) {
	...
	var mesh = BABYLON.Mesh.CreateSphere("bullet", 100, 1, scene);
...
function runDemo(canvasId) {
    ...
    var camera = new BABYLON.FreeCamera("MainCamera", new BABYLON.Vector3(0, 80, 0), scene);
	...
	weapon.material.diffuseTexture = new BABYLON.Texture("img/babylon/weapon.png", scene);
...
function createSkybox(scene) {
	...
	sMaterial.reflectionTexture = new BABYLON.CubeTexture("img/babylon/skybox/skybox", scene);
...
function createDemoScene(scene) {
	...
	ground.material.diffuseTexture = new BABYLON.Texture("img/babylon/ground.png", scene);
	ground.checkCollisions = true;
	
	// Et quelques cubes...
	var boxMaterial = new BABYLON.StandardMaterial("bMaterial", scene);
	boxMaterial.diffuseTexture = new BABYLON.Texture("img/babylon/box.png", scene);
	...
	for (var i = 0; i < 150; i++) {
		...
		box.tag = "enemy";
		box.position = new BABYLON.Vector3(random(0, 100), cubeSize / 2, random(0, 100));
